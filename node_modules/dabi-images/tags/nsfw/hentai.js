...
class HentaiShit {
	...
	pussy() {
        let page = Math.floor(Math.random() *24) +1, tags = ["pussy","cum_in_pussy"],
        url = `https://danbooru.donmai.us/posts?page=${page}&tags=${tags[Math.floor(Math.random() *tags.length)]}`;
        return requestHandler.makeRequest("danbooru", url);
    }
	fate() {
        let page = Math.floor(Math.random() *24) +1, tags = ["fate_(series)","fate/grand_order"],
        url = `https://danbooru.donmai.us/posts?page=${page}&tags=${tags[Math.floor(Math.random() *tags.length)]}`;
        return requestHandler.makeRequest("danbooru", url);
    }
	armpits() {
        let page = Math.floor(Math.random() *24) +1, tags = ["armpits"],
        url = `https://danbooru.donmai.us/posts?page=${page}&tags=${tags[Math.floor(Math.random() *tags.length)]}`;
        return requestHandler.makeRequest("danbooru", url);
    }
	futa() {
        let page = Math.floor(Math.random() *24) +1, tags = ["futa","futanari" ],
        url = `https://danbooru.donmai.us/posts?page=${page}&tags=${tags[Math.floor(Math.random() *tags.length)]}`;
        return requestHandler.makeRequest("danbooru", url);
    }
	loli() {
        let page = Math.floor(Math.random() *24) +1, tags = ["small_breasts" ],
        url = `https://danbooru.donmai.us/posts?page=${page}&tags=${tags[Math.floor(Math.random() *tags.length)]}`;
        return requestHandler.makeRequest("danbooru", url);
    }
	mecha() {
        let page = Math.floor(Math.random() *24) +1, tags = ["mecha" ],
        url = `https://danbooru.donmai.us/posts?page=${page}&tags=${tags[Math.floor(Math.random() *tags.length)]}`;
        return requestHandler.makeRequest("danbooru", url);
    }
}
